...
public class ModalService
{
    ...
    public Task<ModalItem> LaunchAsync<T>(Action<Dictionary<string, object>>? onConfigure = null, string size = "max-w-lg", bool allowUnfocusHide = false) where T : BaseModal
    ...
    public Task CloseAsync(ModalItem item)
        => ModalLauncher.CloseAsync(item);
}